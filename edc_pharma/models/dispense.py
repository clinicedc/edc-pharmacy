...
#     if value:
#         try:
#             value = timezone.make_aware(datetime.combine(
#                 value, time(0)), timezone=pytz.timezone("UTC"))
#         except ValueError:
#             pass
...
#             r'^[A-Z]{2,3}$', message='Use CAPS, 2-3 letters')],
...
#             days = self.total_number_of_tablets / \
#                 (self.times_per_day * self.number_of_tablets)
...
#     initials = models.CharField(
#         max_length=4,
# validators=[RegexValidator(r'^[A-Z]{2,4}$', message='Use CAPS, 2-4
# letters')],)
