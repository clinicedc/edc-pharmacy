# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-09-16 11:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_teaspoons', models.IntegerField(blank=True, help_text='Only required if dispense type SYRUP is chosen', null=True)),
                ...
                ('prepared_datetime', models.DateTimeField(default=datetime.datetime(2016, 9, 16, 13, 8, 47, 788297))),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_datetime', models.DateTimeField(default=datetime.datetime(2016, 9, 16, 13, 8, 47, 779827))),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
