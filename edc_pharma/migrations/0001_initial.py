# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-09-21 07:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_tablets', models.IntegerField(blank=True, help_text='Only required if dispense type TABLET is chosen', null=True)),
                ('syrup_volume', models.CharField(blank=True, help_text='Only required if dispense type SYRUP is chosen', max_length=20, null=True)),
                ('times_per_day', models.IntegerField(blank=True, help_text='Only required if dispense type TABLET or SYRUP is chosen', null=True)),
                ...
                ('total_dosage_volume', models.CharField(blank=True, help_text='Only required if dispense type SYRUP or IV is chosen', max_length=10, null=True)),
                ('iv_concentration', models.CharField(blank=True, help_text='Only required if dispense type IV is chosen', max_length=15, null=True)),
                ('iv_duration', models.CharField(blank=True, help_text='Only required if dispense type IV is chosen', max_length=15, null=True)),
                ('total_concentration', models.CharField(blank=True, help_text='Only required if dispense type IV is chosen', max_length=15, null=True)),
