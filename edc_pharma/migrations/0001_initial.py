# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-10-11 13:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dispense_type', models.CharField(choices=[('TABLET', 'TABLET'), ('SYRUP', 'SYRUP'), ('IV', 'IV'), ('IM', 'IM'), ('SOLUTION', 'SOLUTION'), ('CAPSULES', 'CAPSULES'), ('SUPPOSITORIES', 'SUPPOSITORIES')], default='TABLET', max_length=8)),
                ('number_of_tablets', models.IntegerField(blank=True, help_text='Only required if dispense type TABLET, CAPSULES and or SUPPOSITORIES is chosen', null=True)),
                ('syrup_dose', models.CharField(blank=True, help_text='Only required if dispense type SYRUP is chosen', max_length=20, null=True)),
                ('times_per_day', models.IntegerField(blank=True, help_text='Only required if dispense type TABLET, CAPSULES, SUPPOSITORIES,and or SYRUP is chosen', null=True)),
                ('total_number_of_tablets', models.IntegerField(blank=True, help_text='Only required if dispense type TABLET,  is chosen', null=True)),
                ('total_dosage_volume', models.CharField(blank=True, help_text='Only required if dispense type SYRUP, IM, IV is chosen', max_length=10, null=True)),
                ('total_volume', models.CharField(blank=True, help_text='Only required if dispense type IV and or IM is chosen', max_length=10, null=True)),
                ...
                ('iv_duration', models.CharField(blank=True, help_text='Only required if dispense type IV is chosen', max_length=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initials', models.CharField(help_text='Format is AA or AAA', max_length=5, validators=[django.core.validators.RegexValidator('[A-Z]{2,3}', message='Use CAPS, 2-3 letters')])),
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female')], max_length=10)),
                ('dob', models.DateField(blank=True, null=True, validators=[edc_base.model.validators.date.date_not_future])),
