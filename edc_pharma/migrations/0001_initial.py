# Generated by Django 2.0b1 on 2017-10-31 18:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dosage_guideline', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='edc_pharma.DosageGuideline')),
                ('medication', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='edc_pharma.Medication')),
                ('prescription', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='edc_pharma.Prescription')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='prescription',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='edc_pharma.Prescription'),
        ),
        migrations.AddField(
            model_name='dispenseditem',
            name='prescription_item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='edc_pharma.PrescriptionItem'),
        ),
    ]
