...
class TestDispenseCapsuleForm(TestCase):
    ...
    def setUp(self):
        """Setup data with all required fields for DISPENSE TYPE: CAPSULE"""
    ...
    def test_with_number_of_tablets(self):
        """Test when DISPENSE TYPE:CAPSULE is chosen with number of tablets included"""
    ...
    def test_without_number_of_tablets(self):
        """Test when DISPENSE TYPE:CAPSULE is chosen with number of tablets not included"""
    ...
    def test_without_total_number_of_tablets(self):
        """Test when DISPENSE TYPE:CAPSULE is chosen with total number of tablets not included"""
    ...
    def test_with_total_number_of_tablets(self):
        """Test when DISPENSE TYPE:CAPSULE is chosen with total number of tablets included"""
    ...
    def test_with_dose(self):
        """Test when DISPENSE TYPE:CAPSULE is chosen with dose included"""
        self.data['dose'] = "10ml"
        dispense_form = DispenseForm(data=self.data)
        self.assertIn(
    ...
    def test_without_dose(self):
        """Test when DISPENSE TYPE:CAPSULE is chosen with syrup volume not included"""
        self.data['dose'] = None
        dispense_form = DispenseForm(data=self.data)
        self.assertNotIn(
            'You have selected dispense type capsule, you should NOT enter dose',
    ...
    def test_with_duration(self):
        """Test when DISPENSE TYPE:CAPSULE is chosen and IV duration is included"""
    ...
    def test_with_total_volume(self):
        """Test when DISPENSE TYPE:CAPSULE is chosen and total dosage volume is included"""
    ...
    def test_without_concentration(self):
        """Test when DISPENSE TYPE:CAPSULE is chosen with concentration not included"""
    ...
    def test_without_times_per_day(self):
        """Test when DISPENSE TYPE: CAPSULE is chosen and times per day is not included"""
