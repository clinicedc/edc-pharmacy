# Generated by Django 2.0b1 on 2017-10-31 19:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', edc_base.model_fields.uuid_auto_field.UUIDAutoField(blank=True, editable=False, help_text='System auto field. UUID primary key.', primary_key=True, serialize=False)),
                ('subject_identifier', models.CharField(max_length=50, verbose_name='Subject Identifier')),
                ('dispensed_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow)),
                ('dispensed', models.DecimalField(decimal_places=1, max_digits=6)),
                ('status', models.CharField(choices=[('New', 'New'), ('dispensed', 'Dispensed'), ('cancelled', 'Cancelled')], default='New', max_length=25, verbose_name='Dispensed')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dose_per_kg', models.DecimalField(blank=True, decimal_places=1, help_text='dose per frequency if considering weight', max_digits=6, null=True)),
                ('dose_units', models.CharField(choices=[('mg', 'mg'), ('ml', 'ml'), ('g', 'g'), ('OTHER', 'Other ...'), ('N/A', 'Not applicable')], max_length=25)),
                ('dose_frequency_factor', models.DecimalField(decimal_places=1, default=1, max_digits=6, validators=[django.core.validators.MinValueValidator(1.0)])),
                ('dose_frequency_units', models.CharField(choices=[('hr', 'per hour'), ('day', 'per day'), ('single', 'single dose'), ('OTHER', 'Other ...'), ('N/A', 'Not applicable')], default='day', max_length=10, verbose_name='per')),
                ('subject_weight_factor', models.DecimalField(decimal_places=1, default=1, help_text='factor to convert weight to kg', max_digits=6)),
            ],
        ),
        migrations.CreateModel(
            name='Medication',
            fields=[
                ...
                ('measure', models.DecimalField(decimal_places=1, max_digits=6)),
                ('units', models.CharField(choices=[('mg', 'mg'), ('ml', 'ml'), ('g', 'g'), ('OTHER', 'Other ...'), ('N/A', 'Not applicable')], max_length=25)),
                ('formulation', models.CharField(choices=[('11', 'Tablet'), ('12', 'Capsule'), ('13', 'Vial'), ('14', 'Liquid'), ('15', 'Powder'), ('16', 'Suspension'), ('17', 'Gel'), ('18', 'Oil'), ('19', 'Lotion'), ('20', 'Cream'), ('21', 'Patch'), ('OTHER', 'Other')], max_length=25)),
                ('route', models.CharField(choices=[('10', 'Intramuscular'), ('20', 'Intravenous'), ('30', 'Oral'), ('40', 'Topical'), ('50', 'Subcutaneous'), ('60', 'Intravaginal'), ('70', 'Rectal'), ('OTHER', 'Other')], max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight_in_kgs', models.DecimalField(decimal_places=1, max_digits=6, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_modified', models.CharField(blank=True, max_length=10)),
                ('id', edc_base.model_fields.uuid_auto_field.UUIDAutoField(blank=True, editable=False, help_text='System auto field. UUID primary key.', primary_key=True, serialize=False)),
                ('dose', models.DecimalField(blank=True, decimal_places=1, help_text='Leave blank to auto-calculate', max_digits=6, null=True)),
                ...
                ('frequency_units', models.CharField(choices=[('hr', 'times per hour'), ('day', 'times per day'), ('single', 'single dose'), ('OTHER', 'Other ...'), ('N/A', 'Not applicable')], default='day', max_length=10, verbose_name='per')),
                ...
                ('medication', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='edc_pharmacy.Medication')),
                ('prescription', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='edc_pharmacy.Prescription')),
            ],
            options={
