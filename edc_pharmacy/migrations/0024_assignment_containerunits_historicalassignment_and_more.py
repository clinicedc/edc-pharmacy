...
import edc_pharmacy.models.stock_request.stock_request_processing
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            managers=[
                (
                    "objects",
                    edc_pharmacy.models.stock_request.stock_request_processing.Manager(),
                ),
                ("on_site", edc_sites.managers.CurrentSiteManager()),
            ],
        ),
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False,
                verbose_name="Container may be used for stock repackaging",
            ),
        ),
        migrations.AddField(
            model_name="container",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                db_constraint=False,
                limit_choices_to={"may_repackage_as": True},
                null=True,
                on_delete=django.db.models.deletion.DO_NOTHING,
                related_name="+",
                to="edc_pharmacy.container",
        ...
        migrations.AddField(
            model_name="historicalstockrequestprocessing",
            name="container",
            field=models.ForeignKey(
                blank=True,
                db_constraint=False,
        ...
        migrations.AddField(
            model_name="stockrequestprocessing",
            name="container",
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.PROTECT,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.PROTECT,
                to="edc_pharmacy.labelspecificationproxy",
            ),
        ),
        migrations.AddField(
            model_name="historicalrepackrequest",
        ...
        migrations.AddIndex(
            model_name="stockrequestprocessing",
            index=models.Index(
                fields=["modified", "created"], name="edc_pharmac_modifie_e71d58_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="stockrequestprocessing",
            index=models.Index(
                fields=["user_modified", "user_created"],
                name="edc_pharmac_user_mo_2594aa_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="stocktransferrequest",
