...
from ...models import StockRequestProxy
...
@admin.register(StockRequestProxy, site=edc_pharmacy_admin)
class StockRequestProxyAdmin(ModelAdminMixin, SimpleHistoryAdmin):
