...
class DispenseProfileSelector:
    ...
    def __init__(self, subject_identifier=None, schedule_name=None, schedule_plan=None):
    ...
    def profile(self):
        try:
            profile = self.schedule_plan.get("dispense_profile").get("enrollment")
            ...
            profile = self.schedule_plan.get("dispense_profile").get("followup")
