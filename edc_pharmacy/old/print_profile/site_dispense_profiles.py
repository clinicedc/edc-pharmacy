...
single_dose_enrollment = DispenseProfile(name="enrollment", profile_type="single_dose")
single_dose_enrollment.add_medication_type(medications.get("liposomal_amphotericin"))
single_dose_enrollment.add_medication_type(medications.get("fluconazole_1200mg"))
single_dose_enrollment.add_medication_type(medications.get("flucytosine"))
site_profiles.register(single_dose_enrollment)

single_dose_followup = DispenseProfile(name="followup", profile_type="single_dose")
single_dose_followup.add_medication_type(medications.get("fluconazole_800mg"))
site_profiles.register(single_dose_followup)

control_arm_enrollemnt = DispenseProfile(name="enrollment", profile_type="control")
...
control_followup_profile = DispenseProfile(name="followup", profile_type="control")
control_followup_profile.add_medication_type(medications.get("fluconazole_800mg"))
