...
class TestDispenseAppointmentDescribe(TestCase):
    ...
    def test_dispense_appointment_start_day(self):
        ...
        describe = AppointmentDescriber(dispense_appointment=dispense_appointment)
    ...
    def test_dispense_appointment_human_readiable_days_7(self):
        ...
        appt_describe = AppointmentDescriber(dispense_appointment=dispense_appointment)
    ...
    def test_is_next_pending_appointment_2(self):
        ...
        describe = AppointmentDescriber(dispense_appointment=dispense_appointment1)
